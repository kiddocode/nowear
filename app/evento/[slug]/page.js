...
export default function EventoDetalle() {
  ...
  return (
    <div>
      {/* HERO */}
      <div className="evento-hero" style={{background:'#0A0A0A',padding:'4rem 3rem 3rem',display:'flex',justifyContent:'space-between',alignItems:'flex-end',flexWrap:'wrap',gap:'2rem'}}>
        <div>
        ...
        <div className="evento-hero-link" style={{background:'rgba(255,255,255,0.06)',border:'1px solid rgba(255,255,255,0.1)',padding:'1.25rem 1.5rem',minWidth:'280px'}}>
      ...
      {/* TABS */}
      <div className="evento-tabs" style={{display:'flex',padding:'0 3rem',borderBottom:'1px solid #E0E0DC',background:'#FFFFFF',position:'sticky',top:'68px',zIndex:100,overflowX:'auto'}}>
      ...
      <div className="evento-contenido" style={{padding:'2.5rem 3rem'}}>
                      ...
                      <tr key={i} style={{borderBottom:'1px solid #E0E0DC'}}>
                        <td style={{padding:'0.9rem 1rem'}}>
                          <div style={{display:'flex',gap:'4px',alignItems:'center'}}>
                            <span style={{width:'18px',height:'18px',borderRadius:'50%',background:row.color_hex||'#E0E0DC',border:'1px solid #E0E0DC',display:'inline-block'}}></span>
                            {row.color_hex_2 && <span style={{width:'18px',height:'18px',borderRadius:'50%',background:row.color_hex_2,border:'1px solid #E0E0DC',display:'inline-block'}}></span>}
                          </div>
                        </td>
        ...
        {tabActiva === 3 && (
          <div style={{padding:'2rem',border:'1px solid #E0E0DC'}}>
            <p style={{fontSize:'0.75rem',fontWeight:300,color:'#888884'}}>Ajustes del evento próximamente.</p>
          </div>
        )}
      </div>
    </div>
