  ...
  return (
    <div className="dashboard-grid" style={{display:'grid',gridTemplateColumns:'220px 1fr',minHeight:'calc(100vh - 68px)'}}>
        ...
        <div style={{marginTop:'auto',padding:'1.25rem 1.5rem',borderTop:'1px solid #E0E0DC'}}>
          <div style={{display:'flex',alignItems:'center',gap:'0.75rem'}}>
            ...
            <div>
              ...
              <div style={{fontSize:'0.62rem',fontWeight:300,color:'#888884'}}>{eventos.length} evento{eventos.length !== 1 ? 's' : ''} activo{eventos.length !== 1 ? 's' : ''}</div>
            </div>
          </div>
        </div>
      </aside>
      ...
      <main style={{padding:'3rem'}}>
        ...
        {eventos.length === 0 && (
          <div style={{textAlign:'center',padding:'4rem',color:'#888884',fontSize:'0.75rem',fontWeight:300}}>
