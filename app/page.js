    ...
    <>
      ...
      <section className="hero-grid" style={{display:'grid',gridTemplateColumns:'1fr 1fr',minHeight:'calc(100vh - 68px)'}}>
        ...
        <div className="hero-img-col" style={{position:'relative',overflow:'hidden'}}>
          <video src="https://qhuatexjyxbunotvghjh.supabase.co/storage/v1/object/public/fotos/video-inicio.mp4" autoPlay muted loop playsInline style={{width:'100%',height:'100%',objectFit:'cover',objectPosition:'center top',display:'block'}}/>
...
.casos-grid > :nth-child(11) { grid-column: 6; }
      ...
      <section id="casos" className="section-pad" style={{padding:'7rem 3rem',position:'relative',overflow:'hidden',background:'#0A0A0A'}}>
        ...
        <div style={{position:'absolute',inset:0,zIndex:0}}>
          <video src="https://qhuatexjyxbunotvghjh.supabase.co/storage/v1/object/public/fotos/video-casos.mp4" autoPlay muted loop playsInline style={{width:'100%',height:'100%',objectFit:'cover',opacity:0.25}}/>
