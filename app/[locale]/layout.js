...
const META = {
  es: {
    ...
    description: 'La plataforma para que las invitadas de tu boda no coincidan de vestido. Registra tu look, detecta coincidencias y disfruta tranquila. Desde 9€.',
